...
# PSO algorithm
class PSO:
    def __init__(self, graph, iterations, size_population, beta=1, alfa=1.0):
        ...
        # make sure that solution starts from point 0
        while True:
...
def get_pso(edges, vertices):
    print 'Getting Best Path'
    graph = Graph(amount_vertices=len(vertices))
    for v in edges:
        # print v
